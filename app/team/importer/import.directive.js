angular.module("teambreweryApp").service('text2team', ['EVStats', function(EVStats){
			...
			for (var i=0; i<text.length; i++) {
				...
				if (line === '' || line === '---') {
					...
					for (var j=0; j<evLines.length; j++) {
						...
						var statid = EVStats[evLine.substr(spaceIndex+1)];
					...
					for (var j=0; j<ivLines.length; j++) {
						...
						if (spaceIndex === -1) continue;
						var statid = EVStats[ivLine.substr(spaceIndex+1)];
